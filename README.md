...
The Colab notebook now supports:

- GitHub pull/update flow for code edited locally in VS Code
- Plain text chapter inputs
- Scanned PDF chapter inputs with OCR
- Resume-safe manifests and chapter assembly in Google Drive
